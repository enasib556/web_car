      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Row(
              ...
              children: [
                Flexible(
                  child: Text(
                    '$selectedCarMake $selectedCarModel $selectedCarType ($selectedCarYear) $odometerReading',
          ...
          Flexible(
            ...
            child:  Text(
              AppLocalizations.of(context)!.whatsTheLocationYouWillSellCarFromAr!,
              style: TextStyle(
                fontWeight: FontWeightHelper.extraBold,
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: const InputDecoration(
                labelText: 'Suburb or Postcode (e.g. Burnley, VIC 3121)',
